<?php
function generate_summary_include_ppn($edit, $features = "subtotal", $grid_id, $class = "", $fields = [])
{
    $i = count($edit["field"]);
    ...
    if (strstr($features, "diskon1")) {
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]   = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon1prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon1nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "diskon2")) {
        ...
        $edit["field"][$i]["input_attr"]["maxlength"] = $_SESSION["setting"]["limit_percent"];
        $edit["field"][$i]["input_attr"]["onkeyup"]   = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon2prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon2nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "diskon3")) {
        ...
        $edit["field"][$i]["input_attr"]["maxlength"] = $_SESSION["setting"]["limit_percent"];
        $edit["field"][$i]["input_attr"]["onkeyup"]   = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon3prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary_include_ppn(\"" . $grid_id . "\", \"diskon3nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "pembulatan")) {
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary_include_ppn(\"" . $grid_id . "\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
