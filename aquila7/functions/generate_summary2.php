<?php
function generate_summary2($edit, $features = "subtotal", $grid_id, $class = "", $fields = [])
{
    $i = count($edit["field"]);
    ...
    if (strstr($features, "diskon1")) {
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]   = "calculate_summary2(\"" . $grid_id . "\", \"diskon1prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary2(\"" . $grid_id . "\", \"diskon1nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "diskon2")) {
        ...
        $edit["field"][$i]["input_attr"]["maxlength"] = $_SESSION["setting"]["limit_percent"];
        $edit["field"][$i]["input_attr"]["onkeyup"]   = "calculate_summary2(\"" . $grid_id . "\", \"diskon2prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary2(\"" . $grid_id . "\", \"diskon2nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "diskon3")) {
        ...
        $edit["field"][$i]["input_attr"]["maxlength"] = $_SESSION["setting"]["limit_percent"];
        $edit["field"][$i]["input_attr"]["onkeyup"]	  = "calculate_summary2(\"" . $grid_id . "\", \"diskon3prosentase\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        ...
        $edit["field"][$i]["input_attr"]["onkeyup"]  = "calculate_summary2(\"" . $grid_id . "\", \"diskon3nominal\");";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
    ...
    if (strstr($features, "jasa")) {
        if (!empty($class))
            $edit["field"][$i]["form_group_class"] = $class;
        else
            $edit["field"][$i]["form_group"] = 0;
        $edit["field"][$i]["label"]                  = "Jasa";
        $edit["field"][$i]["input_col"]              = "col-sm-4 no-drop";
        $edit["field"][$i]["input"]                  = "jasa";
        $edit["field"][$i]["input_class"]            = $_SESSION["setting"]["class_money"] . " summary_" . $grid_id;
        $edit["field"][$i]["input_attr"]["id"]       = "sum_jasa_" . $grid_id;
        $edit["field"][$i]["input_attr"]["readonly"] = "readonly";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        if (!empty($fields["jasa"])) {
            $edit["field"][$i] = array_replace($edit["field"][$i], $fields["jasa"]);
            if (isset($fields["jasa"]["input_attr"]["readonly"]) && $fields["jasa"]["input_attr"]["readonly"] != "readonly")
                unset($edit["field"][$i]["input_attr"]["readonly"]);
            if (isset($fields["jasa"]["input_attr"]["disabled"]) && $fields["jasa"]["input_attr"]["disabled"] != "disabled")
                unset($edit["field"][$i]["input_attr"]["disabled"]);
        }
        $i++;
    }
    ...
    if (strstr($features, "totaltagihan")) {
        if (!empty($class))
            $edit["field"][$i]["form_group_class"] = $class;
        else
            $edit["field"][$i]["form_group"] = 0;
        $edit["field"][$i]["label"]                  = "Total";
        $edit["field"][$i]["input_col"]              = "col-sm-4 no-drop";
        $edit["field"][$i]["input"]                  = "total_tagihan";
        $edit["field"][$i]["input_class"]            = $_SESSION["setting"]["class_money"] . " summary_" . $grid_id;
        $edit["field"][$i]["input_attr"]["id"]       = "sum_totaltagihan_" . $grid_id;
        $edit["field"][$i]["input_attr"]["readonly"] = "readonly";
        if ($edit["mode"] == "add")
            $edit["field"][$i]["input_value"] = "0";
        if (!empty($fields["totaltagihan"])) {
            $edit["field"][$i] = array_replace($edit["field"][$i], $fields["totaltagihan"]);
            if (isset($fields["totaltagihan"]["input_attr"]["readonly"]) && $fields["totaltagihan"]["input_attr"]["readonly"] != "readonly")
                unset($edit["field"][$i]["input_attr"]["readonly"]);
            if (isset($fields["totaltagihan"]["input_attr"]["disabled"]) && $fields["totaltagihan"]["input_attr"]["disabled"] != "disabled")
                unset($edit["field"][$i]["input_attr"]["disabled"]);
        }
        $i++;
    }
