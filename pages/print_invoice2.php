...
<body onload="<?=$onload?>">
	...
	<div id="wrapper">
		<?php 
			if(isset($_GET['t'])){
				include $page_dir."contents/menu_frame/".$_SESSION["g.frame"]."-".$_SESSION["g.menu"]."-print_".$_GET['t'].".php";
			}else{
				include $page_dir."contents/menu_frame/".$_SESSION["g.frame"]."-".$_SESSION["g.menu"]."-print.php";
			}
		?>
	</div>
