...
<script language="javascript" type="text/javascript">
    ...
    function get_komposisi_column_all_row() {
        ...
        $('#sum_komposisi_2').val(komposisi_column_all_row)

        var sum_komposisi_1 = $('#sum_komposisi_1').val()
        $('#struktur_packaging').val(komposisi_column_all_row + ' / ' + sum_komposisi_1)

        return komposisi_column_all_row;
    }

    function sum_subtotal_<?= $grid_id ?>() {
        sum_subtotal_spesifikasi_produk_detail_komposisi1()
        get_komposisi_column_all_row()
    ...
    function row_validation_<?= $grid_id ?>(rowid) {
        ...
        var cells = [
            "nomormhbarang|ID Barang", "mikron|Mikron"
        ];
