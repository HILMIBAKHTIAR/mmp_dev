	...
	function sum_subtotal_<?=$grid_id?>()
{
	...
	function after_save_cell_<?= $grid_id ?>(rowid, cellname) {
		...
		// var qty = parseFloat(jQuery(<?= $grid_id ?>_element).jqGrid('getCell', rowid, 'qty'));

		// if (qty > qty_permintaan) {
		// 	jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'qty', qty_permintaan);
		// 	alert(`Jumlah beli (${qty}) tidak boleh lebih dari jumlah permintaan (${qty_permintaan})`);
		// }
		// if (qty < qty_permintaan) {
		// 	jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'qty', qty);
		// }
		// else {
		// 	jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'qty', qty_permintaan);
		// }
