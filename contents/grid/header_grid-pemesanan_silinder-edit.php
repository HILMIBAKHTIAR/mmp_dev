...
$edit["field"][$i]["browse_set"]["param_output"]     = array(
    ...
    "proses_cilinder|proses",
    "kode_cilinder|kode_silinder",
    "surface|surfaces",
    "reverse|reverses",
...
$edit["field"][$i]["input_element"]                 = "select1";
$edit["field"][$i]["input_option"]                     = array("SURFACE|SURFACE", "RESERVE|RESERVE");
$i++;
$edit["field"][$i]["label"]                         = "Bagian Transparan";
$edit["field"][$i]["input"]                         = "bagian_transpan";
$edit["field"][$i]["input_element"]                 = "select1";
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        ...
        <label class='container control-label' style='text-align:left;margin-left: 16px;'> <b> CYLINDER BASE </b> &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;
...
$edit["field"][$i]["input_element"] = "
    <br> 
    <div class='col-sm-12'>
        <label class='container control-label' style='text-align:left;margin-left: -250px;'>
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        ...
        <label class='container control-label' style='text-align:left;margin-left: 43px;'> <b> SISI CETAK </b> &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        <label class='container control-label' style='text-align:left;margin-left: -25px;'> <b> BAGIAN TRANSPARAN </b> &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        <label class='container control-label' style='text-align:left;margin-left: -25px;'> <b> PROCESSING SYSTEM </b> &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-6'>
    <label class='container control-label' style='text-align:left;margin-left: -380px;'>
...
//     <div class='col-sm-12'>
//     <label class='container control-label' style='text-align:left;margin-left: 200px;'>
//         <input type='checkbox' id='ikutexisting' name='ikutexisting'>
//         <span class='checkmark' style='top:34%'></span> &nbsp;
//         ikutexisting &nbsp;
//     </label>
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        <label class='container control-label' style='text-align:left;margin-left: 25px;'> <b> KEPEMILIKAN </b> &nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    function test() {
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", "#newbase, #oldbase, #engrave, #laser, #ikutexisting", function() {
                var id = $(this).attr("id");
                var oppositeIds = {
                    "newbase": "oldbase",
                    "oldbase": "newbase",
                    "engrave": ["laser", "ikutexisting"],
                    "laser": ["engrave", "ikutexisting"],
                    "ikutexisting": ["engrave", "laser"]
                };

                if ($(this).is(':checked')) {
                    $(this).val(1);

                    if (Array.isArray(oppositeIds[id])) {
                        for (var i = 0; i < oppositeIds[id].length; i++) {
                            $("#" + oppositeIds[id][i]).prop("checked", false).attr("disabled", true);
                        }
                    } else {
                        $("#" + oppositeIds[id]).prop("checked", false).attr("disabled", true);
                    }
                } else {
                    $(this).val(0);
                    ...
                    if (Array.isArray(oppositeIds[id])) {
                        for (var i = 0; i < oppositeIds[id].length; i++) {
                            $("#" + oppositeIds[id][i]).attr("disabled", false);
                        }
                    } else {
                        $("#" + oppositeIds[id]).attr("disabled", false);
                    }
                }
            });


            $(document).on("click", "#surface, #reverse", function() {
                if ($(this).is(':checked')) {
                    $(this).val(1);
                    if ($(this).attr("id") == "surface") {
                        $("#reverse").attr("disabled", true);
                    } else {
                        $("#surface").attr("disabled", true);
                    }
                } else {
                    $(this).val(0);
                    $("#surface, #reverse").attr("disabled", false);
                }

            });


            $(document).on("click", "#ada, #tidakada", function() {
                if ($(this).is(':checked')) {
                    $(this).val(1);
                    if ($(this).attr("id") == "ada") {
                        $("#tidakada").attr("disabled", true);
                    } else {
                        $("#ada").attr("disabled", true);
                    }
                } else {
                    $(this).val(0);
                    $("#ada, #tidakada").attr("disabled", false);
                }
            ...
            $(document).on("click", "#mmp, #customer", function() {
                if ($(this).is(':checked')) {
                    $(this).val(1);
                    if ($(this).attr("id") == "mmp") {
                        $("#customer").attr("disabled", true);
                    } else {
                        $("#mmp").attr("disabled", true);
                    }
                } else {
                    $(this).val(0);
                    $("#mmp, #customer").attr("disabled", false);
                }
