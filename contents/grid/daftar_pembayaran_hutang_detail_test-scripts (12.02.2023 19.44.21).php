...
<script language="javascript" type="text/javascript">
	...
	function after_complete_<?= $grid_id ?>(rowid, cellname) {
		...
		if (cellname == 'account') {
			if (<?= $grid_id ?>_selected_suggest && <?= $grid_id ?>_selected_suggest.account_data) {
				...
				jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'nomormhaccount', <?= $grid_id ?>_selected_suggest.account_data.nomor);
			}
		}
