	...
	function after_complete_<?= $grid_id ?>(rowid, cellname) {
		...
		if (cellname == 'satuan_berat') {
			if (<?= $grid_id ?>_selected_suggest && <?= $grid_id ?>_selected_suggest.master_satuan_berat) {
				const nomormhsatuan_berat_purchasing = <?= $grid_id ?>_selected_suggest.master_satuan_berat.nomor
				jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'nomormhsatuanberat', nomormhsatuan_berat_purchasing);
				jQuery(<?= $grid_id ?>_element).jqGrid('setCell', rowid, 'satuan_berat', <?= $grid_id ?>_selected_suggest.master_satuan_berat.nama);
			}
		}
