...
<script language="javascript" type="text/javascript">
    ...
    function autocomplete_satuan_qty_accounting(element) {
    ...
    function autocomplete_satuan_panjang_accounting(element) {
        $(element).on('keyup', function(e) {
            if (e.which === 113)
	...
	function autocomplete_satuan_berat_accounting(element) {
        $(element).on('keyup', function(e) {
            if (e.which === 113)
