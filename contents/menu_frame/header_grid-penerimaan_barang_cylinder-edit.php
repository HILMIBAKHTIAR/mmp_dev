...
//------------------------------------------------GRID DATA 1------------------------------------------------------
$i = 0;
$edit["detail"][$i]["table_name"] = "tdbelipenerimaancylinder";
...
if ($edit["mode"] != "add") {
    ...
    from thbelipenerimaancylinder x
	JOIN " . $edit["detail"][0]["table_name"] . " a on a.nomorthbelipenerimaancylinder = x.nomor and a.status_aktif > 0
