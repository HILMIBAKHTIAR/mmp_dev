...
$index_table["data"][$i]["kodepo"]         = $data["kodepo"];
$index_table["data"][$i]["kode"]         = $data["kode"];
$index_table["data"][$i]["no_md"]         = $data["no_md"];
$features = "save|back|reload|add|edit|delete".check_approval($data, "edit|approve|disappr");
