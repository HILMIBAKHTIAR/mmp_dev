...
<body>
	...
	<table>
		...
		<tr>
			<p style="text-align: center;">
				<strong>
					FORM PROPOSAL PROGRAM TRADE PROMO
				</strong>
			</p>
		</tr>
		...
		<tr>
			<p style="text-align: center;">
				<input type="checkbox" id="nonPabrikasiCheckbox" <?= $row["is_pabrikasi"] == 0 ? "checked" : "" ?>> Baru &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
				<input type="checkbox" id="pabrikasiCheckbox" <?= $row["is_pabrikasi"] == 1 ? "checked" : "" ?>> Perpanjangan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
				<input type="checkbox" id="pabrikasiCheckbox" <?= $row["is_pabrikasi"] == 1 ? "checked" : "" ?>> Perubahan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
				<input type="checkbox" id="pabrikasiCheckbox" <?= $row["is_pabrikasi"] == 1 ? "checked" : "" ?>> Pengajuan Uang &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
			</p>
		</tr>
	</table>
	...
	<table>
		<tr>
			<p>
				<strong>
					Nomor Program <span style="margin-left: 25px;"> : <?= $row["kode"] ?></span>
				</strong>
			</p>

			<p>
				<strong>
					Nama Program <span style="margin-left: 31px;"> : <?= $row["kode"] ?></span>
				</strong>
			</p>

			<p>
				<strong>Periode </strong>
				<span style="margin-left: 72px;"> : <?= $row["kode"] ?></span>
				
			</p>

			<p>
				<strong>Wilayah Program </strong>
				<span style="margin-left: 18px;"> : <?= $row["kode"] ?></span>
			</p>

			<p>
				<strong>Tujuan</strong>
				<span style="margin-left: 78px;"> : <?= $row["kode"] ?></span>
				
			</p>

			<p>
				<strong>
					Produk Promo<span style="margin-left: 34px;"> : <?= $row["kode"] ?></span>
				</strong>
			</p>

			<p>
				<strong>Mekanisme</strong>
				 <span style="margin-left: 52px;"> : <?= $row["kode"] ?></span>
			</p>



				<table>
				<td width="60%"> tests</td>

				<td width="10%"> lorem30</td>
