...
$edit["field"][$i]["label_class"] 					= "req";
$edit["field"][$i]["input"] 						= "nomormhproses";
$edit["field"][$i]["input_class"] 					= "required";
$edit["field"][$i]["input_element"] 				= "browse";
$edit["field"][$i]["browse_setting"] 				= "master_proses";
$i++;

$edit["field"][$i]["label"] 						= "Grade";
$edit["field"][$i]["label_class"] 					= "req";
$edit["field"][$i]["input"] 						= "nomormhgrade";
$edit["field"][$i]["input_class"] 					= "required";
$edit["field"][$i]["input_element"] 				= "browse";
$edit["field"][$i]["browse_setting"] 				= "master_grade";
$i++;
...
$edit["field"][$i]["label"] 						= "Pemakaian";
$edit["field"][$i]["input"] 						= "pemakaian";
$i++;


$edit["field"][$i]["label"] 						= "Rasio";
$edit["field"][$i]["input"] 						= "rasio";
$i++;
...
// $edit["field"][$i]["input_class"] 				    = "required";
$edit["field"][$i]["input_element"] 				= "browse";
$edit["field"][$i]["browse_setting"] 				= "master_satuan_berat_purchasing";
$i++;
...
// $edit["field"][$i]["input_class"] 				    = "required";
$edit["field"][$i]["input_element"] 				= "browse";
$edit["field"][$i]["browse_setting"] 				= "master_satuan_berat_gudang";
$i++;
// --------------------------------------------END GUDANG---------------------------------
...
// $edit["field"][$i]["input_class"] 				    = "required";
$edit["field"][$i]["input_element"] 				= "browse";
$edit["field"][$i]["browse_setting"] 				= "master_satuan_berat_accounting";
$i++;
...
if ($edit["mode"] != "add") {
    ...
    CONCAT(d.nama, '|', d.nomor) AS 'browse|nomormhproses',
    CONCAT(h.nama, '|', h.nomor) AS 'browse|nomormhgrade'
	FROM " . $edit["table"] . " a
	LEFT JOIN mhbarangjenis b ON a.nomormhbarangjenis = b.nomor 
    left join mdbarangsatuan c on a.nomor = c.nomormhbarang 
    left join mhproses d on a.nomormhproses = d.nomor  
    ...
    left join mhgrade h on a.nomormhgrade = h.nomor
    --     qty
