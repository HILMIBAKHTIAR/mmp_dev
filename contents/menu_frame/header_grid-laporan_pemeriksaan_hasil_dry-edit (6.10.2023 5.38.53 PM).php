...
//------------------------------------------------GRID DATA 2------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdqapdry_grammature";
$edit["detail"][$i]["field_name"] = array(
    "luar",
    "tengah",
    "dalam",
...
$edit["detail"][$i]["additional_where"] = "";
$edit["detail"][$i]["string_id"] = "";
$edit["detail"][$i]["grid_id"] = $_SESSION["menu_" . $_SESSION["g.menu"]]["string"] . "_detail_grammature";
$i++;
//------------------------------------------------END GRID DATA 2------------------------------------------------------
...
$edit["field"][$i]["grid_set"]["option"]["caption"] = "'DATA GRAMMATURE'";
$edit["field"][$i]["grid_set"]["option"]["colNames"] = "
'Item',
'Luar',
'Tengah',
...
$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'item'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'item'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
$j++;

$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'luar'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'luar'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
// $edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
$j++;

$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'tengah'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'tengah'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
// $edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
$j++;

$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'dalam'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'dalam'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
// $edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
$j++;
