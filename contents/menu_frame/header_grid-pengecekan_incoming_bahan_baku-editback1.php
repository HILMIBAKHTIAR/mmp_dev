...
$edit["field"][$i]["grid_set"]["colHeader"][$row]["groupHeaders"][$k]["titleText"]             = "'Aktual Sample'";
$k++;
...
<script type="text/javascript">
    function load_grid_detail() {
        var pages2 = 'pages/grid_load.php?id=pengecekan_incoming_bahan_baku_detail_specification-load';
    ...
    function load_grid_detail2() {
        var pages2 = 'pages/grid_load.php?id=pengecekan_incoming_bahan_baku_detail_visual-load';
