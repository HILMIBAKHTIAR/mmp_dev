...
<?php
	...
	JOIN mhrelasi bs ON a.nomormhrelasi = bs.nomor AND bs.status_aktif > 0
	...
	REPLACE(GROUP_CONCAT(CONCAT(FORMAT(a.subtotal_idr,0),'<br>')),',','') AS 'total_idr'
...
<!-- 			  	<tr class="rowhorizontal">
			...
			<table class="tg">
			  	<tr class="rowhorizontal">
				    ...
				    <td class="rowvertical"  colspan="2" style="height: 30px;">Supplier: <?php echo $row["supplier"]; ?></td>
			  	</tr>
				<tr class="rowhorizontal">
					<td width="5%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>NO</b></td>
					<td width="25%" class="rowvertical" colspan="2" style="text-align: center; background-color: #C0C0C0"><b>Nota</b></td>
					<td width="10%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>Jumlah<br>Tagihan</b></td>
					<td width="10%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>PPH 23</b></td>
					<td width="10%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>Dibayar</b></td>
					<td width="10%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>Sisa</b></td>
					<td width="30%" class="rowvertical" rowspan="2" style="text-align: center; background-color: #C0C0C0"><b>Catatan</b></td>
				</tr>
				<tr class="rowhorizontal">
				...
				<?php
					...
					if ($resultdetail2->num_rows > 0) {
						while($rowdetail = $resultdetail2->fetch_assoc()) {
							if($ctr==1){
								$temp = $rowdetail["transaksi_kode"];
							}
							if($rowdetail["transaksi_kode"]==$temp){
								$arr["transaksi_kode"][$i] = $rowdetail["transaksi_kode"];
								$arr["pph"][$i] = $rowdetail["pph"];
					...
					<tr class="rowhorizontal">
						...
						<td class="rowvertical" style="text-align: left;"><?php echo $arr["transaksi_kode"][$j]; ?>
						</td>
						<td class="rowvertical" style="text-align: left;"><?php echo $row["tanggal"]; ?></td>
						<td class="rowvertical" style="text-align: right;"><?= number_formatting($arr["sisa"][$j], 'currency') ?></td>
						<td class="rowvertical" style="text-align: right;"><?= number_formatting($arr["pph"][$j], 'currency') ?></td>
						<td class="rowvertical" style="text-align: right;"><?= number_formatting($arr["subtotal"][$j], 'currency') ?></td>
						<td class="rowvertical"><?php echo $arr["sisa"][$j] - $arr["subtotal"][$j]; ?></td>
