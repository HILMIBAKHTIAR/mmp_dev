...
$edit['sp_add'] = "sp_add_thspesifikasiproduk";
$edit["sp_add_param"] = array("param_nomormhadmin|0", "param_mode|1");
$edit['sp_edit'] = "sp_add_thspesifikasiproduk";
...
//------------------------------------------------GRID DATA 4------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdspesifikasiproduk_proses";
$edit["detail"][$i]["field_name"] = array(
    "proses",
    "nomormhproses",
    "nomor"
...
$edit["detail"][$i]["additional_where"] = "";
$edit["detail"][$i]["string_id"] = "";
$edit["detail"][$i]["grid_id"] = $_SESSION["menu_" . $_SESSION["g.menu"]]["string"] . "_detail_proses";
$i++;
//------------------------------------------------END GRID DATA 4------------------------------------------------------


$edit["detail"][$i]["table_name"] = "tdspesifikasiproduk_strukturpackaging";
$edit["detail"][$i]["field_name"] = array(
    "struktur_packaging",
    "nomor"
);
...
$edit["field"][$i]["browse_set"]["param_output"] = array(
    ...
    "pitch|pitch",
    "length|length",
    "sum_mikron_1|sum_mikron_1",
    "sum_mikron_2|sum_mikron_2",
    "customer|customer",
    "printing|printing",
...
$edit["field"][$i]["input_element"] = "select1";
$edit["field"][$i]["input_option"] = array("3 INCH|3 INCH", "6 INCH|6 INCH", "9 INCH|9 INCH");
// $edit["field"][$i]["input_attr"]["maxlength"]     = "200";
...
$edit["field"][$i]["input_attr"]["readonly"]  = "readonly";
$edit["field"][$i]["label_class"]                 = "req";
$edit["field"][$i]["input_attr"]["onchange"] = "calculate_thickness()";
$edit["field"][$i]["input_class"]                        = "iptnumber required";
$edit["field"][$i]["input_attr"]["maxlength"]     = "200";
if ($edit['mode'] == 'add') {
...
$edit["field"][$i]["form_group_class"]       = "hiding";
$edit["field"][$i]["label"]                     = "Sum kompoisisi 1";
$edit["field"][$i]["input"]                        = "sum_komposisi_1";
$edit["field"][$i]["input_attr"]["readonly"]  = "readonly";
// $edit["field"][$i]["label_class"]                 = "req";
// $edit["field"][$i]["input_class"]                        = " required";
$edit["field"][$i]["input_attr"]["maxlength"]     = "200";
...
$edit["field"][$i]["form_group_class"]       = "hiding";
$edit["field"][$i]["label"]                     = "Sum kompoisisi 2";
$edit["field"][$i]["input"]                        = "sum_komposisi_2";
$edit["field"][$i]["input_attr"]["readonly"]  = "readonly";
// $edit["field"][$i]["label_class"]                 = "req";
// $edit["field"][$i]["input_class"]                        = " required";
$edit["field"][$i]["input_attr"]["maxlength"]     = "200";
...
if ($edit["mode"] != "add") {
    ...
    echo $edit["field"][$grid[3]]["grid_set"]["query"];
...
<script type="text/javascript">
    ...
    function load_grid_detail4() {
        var no = $('#browse_hasil_analisa_sample_hidden').val();
        var pages = 'pages/grid_load.php?id=spesifikasi_produk_detail_proses-load&no=' + no + '';
    ...
    function load_grid_detail5() {
        var no = $('#browse_hasil_analisa_sample_hidden').val();
        var pages = 'pages/grid_load.php?id=spesifikasi_produk_detail_strukturpackaging-load&no=' + no + '';
    ...
    function hide_and_show() {
        ...
        if (mode == 'edit') {
            $('#is_hasilanalisa').attr('readonly', 1)
        }
