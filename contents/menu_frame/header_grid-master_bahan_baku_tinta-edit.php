...
$edit["field"][$i]["browse_set"]["param_output"]             = ["nama|nama"];
$i++;
...
$i++;
$edit["field"][$i]["label"]                     = "Tipe Film";
$edit["field"][$i]["label_class"]                 = "req";
$edit["field"][$i]["input"]                     = "nomormdbarangtipe";
$edit["field"][$i]["input_class"]                 = "required";
$edit["field"][$i]["input_element"]             = "browse";
$edit["field"][$i]["browse_setting"]             = "master_tipe";
...
// $edit["field"][$i]["input_class"]                     = "required";
$edit["field"][$i]["input_element"]                 = "browse";
$edit["field"][$i]["browse_setting"]                 = "master_satuan_berat";
$i++;
// --------------------------------------------END PRODUKSI---------------------------------
...
if ($edit["mode"] != "add") {
    ...
    CONCAT(b.jenis, '|', b.nomor) AS 'browse|nomormhbarangjenis',
    CONCAT(g.nama, '|', g.nomor) AS 'browse|nomormhgudang',
    CONCAT(y.tipe, '|', y.nomor) AS 'browse|nomormdbarangtipe',
    CONCAT(h.nama, '|', h.nomor) AS 'browse|nomormhwarna',
	--     produksi
	...
	FROM " . $edit["table"] . " a
	JOIN mhbarangjenis b ON a.nomormhbarangjenis = b.nomor 
    ...
    join mhwarna h on h.nomor = a.nomormhwarna
    --     qty
