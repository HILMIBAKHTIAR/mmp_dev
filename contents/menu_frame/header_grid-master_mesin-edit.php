...
$i++;
//browse jenis mesin
$edit["field"][$i]["label"]                     = "Jenis mesin";
$edit["field"][$i]["label_class"]                 = "req";
$edit["field"][$i]["input"]                     = "nomormhjenismesin";
$edit["field"][$i]["input_class"]                 = "required";
$edit["field"][$i]["input_element"]             = "browse";
$edit["field"][$i]["browse_setting"]             = "master_jenismesin_all";
$edit["field"][$i]["browse_set"]["id"]             = "master_jenismesin_all";
$i++;
...
if ($edit["mode"] != "add") {
    $edit["query"] = "
	SELECT a.*,
    CONCAT(' ', b.nama, '|', b.nomor) AS 'browse|nomormhjenismesin'
	FROM " . $edit["table"] . " a
    LEFT JOIN mhjenismesin b on a.nomormhjenismesin = b.nomor
