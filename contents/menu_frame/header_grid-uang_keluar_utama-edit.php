...
$edit["unique"] = array();
$edit["string_code"] = "kode_uang_keluar_utama";
...
$j = 0;
$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'transaksikodedph'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'transaksikodedph'";
...
if($edit["mode"] != "add")
{
	...
	SELECT a.*,
	b.kode transaksikodedph
	FROM ".$edit["detail"][0]["table_name"]." a
	LEFT JOIN thpenagihanhutang b on b.nomor = a.transaksinomor and a.transaksitabel = 'thpenagihanhutang'
