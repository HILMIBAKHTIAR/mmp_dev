...
$edit['sp_add'] = "sp_add_pra_order_beli";
$edit["sp_add_param"] = array("param_nomormhadmin|0", "param_mode|1");
$edit['sp_edit'] = "sp_add_pra_order_beli";
...
$edit["field"][$i]["grid_set"]["colHeader"][$row]["groupHeaders"][$k]["titleText"]     		= "'Kode Permintaan'";
$k++;

$edit["field"][$i]["grid_set"]["colHeader"][$row]["useColSpanStyle"]           				= "true";
$edit["field"][$i]["grid_set"]["colHeader"][$row]["groupHeaders"][$k]["startColumnName"]	= "'kode_barang'";
...
$edit["field"][$i]["grid_set"]["colHeader"][$row]["groupHeaders"][$k]["numberOfColumns"]    = "16";
...
if ($r["status_disetujui"] == 1) {
	$features = "add|back|reload|disappr";
} else {
	$features = "add|save|back|reload|approve|edit";
}
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		// load_grid_detail();
		// console.log(<?= $r["status_disetujui"] ?>);
		// $('#total').val(0, 0);
	});
