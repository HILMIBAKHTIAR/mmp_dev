...
//------------------------------------------------GRID DATA 1------------------------------------------------------
$i = 0;
$edit["detail"][$i]["table_name"] = "tdpermintaanbarang";
...
$edit["field"][$i]["input_option"] 					= array("baku|Baku","pengemas|Pengemas");
$i++;
...
if ($edit["mode"] != "add") {
	...
	SELECT
    a.*,
    b.nama as satuan_barang
	FROM " . $edit["detail"][0]["table_name"] . " a
    left join mhsatuan b on b.nomor = a.nomormhsatuan
