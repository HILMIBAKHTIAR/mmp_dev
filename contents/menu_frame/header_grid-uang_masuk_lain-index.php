...
$index["query_select"] = " 	SELECT
							...
							FROM tduangmasuk a1 join mhaccount x on x.nomor = a1.nomormhaccount WHERE a1.nomorthuangmasuk = a.nomor AND a1.status_aktif>0) account,
							(SELECT GROUP_CONCAT(DISTINCT CONCAT('&#x25C8;&nbsp;', a1.keterangan) SEPARATOR '<br>') 
							FROM tduangmasuk a1 WHERE a1.nomorthuangmasuk = a.nomor AND a1.status_aktif>0) keterangan_td
							from thuangmasuk a
