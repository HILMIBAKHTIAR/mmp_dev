...
//------------------------------------------------GRID DATA 1------------------------------------------------------
$i = 0;
$edit["detail"][$i]["table_name"] = "tdqapresin_visual";
...
//------------------------------------------------GRID DATA 2------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdqapresin_other";
$edit["detail"][$i]["field_name"] = array(
    "defects",
    "parameter",
    "aktual_sample_1",
...
$edit["field"][$i]["input_class"]                 = "required";
$edit["field"][$i]["input_element"]             = "browse";
$edit["field"][$i]["browse_setting"]             = "master_barang_resin";
$i++;
...
<script type="text/javascript">
    ...
    function load_grid_detail() {
        ...
        var pages = 'pages/grid_load.php?id=pengecekan_incoming_resin_detail_visual-load';
