...
$index_table["column"][$i]["name"] 		= "kodepas";
$index_table["column"][$i]["sort"] 		= "kodepas";
$index_table["column"][$i]["search"] 	= 1;
...
$index_table["column"][$i]["sort"] 		= "produk";
$index_table["column"][$i]["search"] 	= 1;
...
$index_table["column"][$i]["search"] 	= 1;
$index_table["column"][$i]["caption"] 	= "Tanggal Dibuat";
$index_table["column"][$i]["align"] 	= "";
$index_table["column"][$i]["width"] 	= "";
$i++;
...
SELECT a.* FROM (
	SELECT
		a.*,
		b.produk as produk, b1.kode as kodepas, c.nama as jenispackaging,
	...
	left join mharchievedfiles ma on ma.file_nomor = a.nomor and ma.file_tabel = 'thlayoutsample' and ma.kategori = 'LAYOUT_SAMPLE'
	GROUP BY a.nomor
) a
";
