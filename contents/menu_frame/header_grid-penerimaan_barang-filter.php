...
$relasihutang = mysqli_fetch_array(mysqli_query($con, "SELECT CONCAT('[', a.kode, '] ', a.nama)  AS info, a.kode FROM mhrelasi a WHERE a.nomormhbarangkelompok = 2 and a.nomor = " . $_POST["nomormhrelasi"]));
