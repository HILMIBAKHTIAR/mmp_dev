...
$edit["field"][$i]["label"] 					= "nomordepartement";
$edit["field"][$i]["input"]						= "nomordepartement";
...
$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'nomortdbelipermintaanmaster'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'nomortdbelipermintaanmaster'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["hidden"] = "true";
$j++;
...
<script type="text/javascript">
    ...
    function load_grid_detail() {
		var no = $('#nomordepartement').val();

		var pages = 'pages/grid_load.php?id=permintaan_pembelian_detail-load&no=' + no + '';
