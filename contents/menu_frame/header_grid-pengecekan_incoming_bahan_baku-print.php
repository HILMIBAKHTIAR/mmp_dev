...
$sql2 = "SELECT 
			a.*
			FROM tdqapbahanbaku_specification a
			where a.status_aktif > 0
			AND a.nomorthqapbahanbaku = " . $row['nomor'];

$result2 = $conn->query($sql2);

$sql3 = "SELECT 
			a.*
			FROM tdqapbahanbaku_visual a
			where a.status_aktif > 0
			AND a.nomorthqapbahanbaku = " . $row['nomor'];
			...
			<td width="60%" style="text-align: center">
				...
				<table>
					...
					<tr>
						...
						PENGECEKAN INCOMING BAHAN BAKU
					</tr>
