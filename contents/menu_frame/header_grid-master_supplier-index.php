...
$i = 0;
$index_filter["field"][$i]["label"]                     = "Kategori Supplier";
// $index_filter["field"][$i]["label_class"]                 = "req";
$index_filter["field"][$i]["input"]                     = "nomormhrelasikategori";
// $index_filter["field"][$i]["input_class"]                 = "required";
$index_filter["field"][$i]["input_element"]             = "browse";
$index_filter["field"][$i]["browse_setting"]             = "master_kategorisupplier";
$i++;
...
$index["query_where"] .= "AND a.nomormhrelasikelompok = 2 AND a.nomor <> 0 AND a.status_aktif > 0";
