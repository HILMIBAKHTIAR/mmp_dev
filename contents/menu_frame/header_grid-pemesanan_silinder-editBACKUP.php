...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        ...
        <label class='container control-label' style='text-align:left;margin-left: 50px;'> OLD BASE &nbsp;
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        ...
        <label class='container control-label' style='text-align:left;margin-left: 50px;'> SURFACE &nbsp;
...
$edit["field"][$i]["input_element"] = "
    ...
    <div class='col-sm-12'>
        <label class='container control-label' style='text-align:left;'> <br> 
        <label class='container control-label' style='text-align:left;margin-left: 50px;'> REVERSE &nbsp;
