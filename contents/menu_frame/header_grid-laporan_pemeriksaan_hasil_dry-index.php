...
$index_table["column"][$i]["name"] 		= "shift";
$index_table["column"][$i]["sort"] 		= "";
$index_table["column"][$i]["search"] 	= 1;
$index_table["column"][$i]["caption"] 	= "Shift";
$index_table["column"][$i]["align"] 	= "";
$index_table["column"][$i]["width"] 	= "";
$i++;
...
$index_table["column"][$i]["name"] 		= "nomor_spk";
$index_table["column"][$i]["sort"] 		= "";
$index_table["column"][$i]["search"] 	= 1;
$index_table["column"][$i]["caption"] 	= "No. SPK";
$index_table["column"][$i]["align"] 	= "";
$index_table["column"][$i]["width"] 	= "";
$i++;

$index_table["column"][$i]["name"] 		= "nama_produk";
$index_table["column"][$i]["sort"] 		= "";
$index_table["column"][$i]["search"] 	= 1;
$index_table["column"][$i]["caption"] 	= "Nama Produk";
$index_table["column"][$i]["align"] 	= "";
$index_table["column"][$i]["width"] 	= "";
$i++;

$index_table["column"][$i]["name"] 		= "komposisi_bahan";
$index_table["column"][$i]["sort"] 		= "";
$index_table["column"][$i]["search"] 	= 1;
$index_table["column"][$i]["caption"] 	= "Komposisi Bahan";
$index_table["column"][$i]["align"] 	= "";
$index_table["column"][$i]["width"] 	= "";
$i++;
