...
<div id="tabimages" style="position:absolute;top:35px;right:100px; width: 400px;">
	<div class="slideshow-container">
		<?php
		if ($edit["mode"] != "add" && count($arr_images) > 0) {
			for ($counter_images = 0; $counter_images < count($arr_images); $counter_images++) { ?>
				<div class="mySlides">
					<img src="<?= $arr_images[$counter_images]; ?>" onclick="popup('<?= $arr_images[$counter_images]; ?>')" style="height:200px;">
					<div class="text"></div>
				</div>
			<?php } ?>
