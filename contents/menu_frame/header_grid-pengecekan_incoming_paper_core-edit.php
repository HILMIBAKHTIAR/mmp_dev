...
$i = 0;
//------------------------------------------------GRID DATA 1------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdqappapercore_specification";
...
//------------------------------------------------GRID DATA 2------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdqappapercore_visual";
$edit["detail"][$i]["field_name"] = array(
    "aktual_sample_1",
    "aktual_sample_2",
    "aktual_sample_3",
...
//------------------------------------------------GRID DATA 3------------------------------------------------------
$edit["detail"][$i]["table_name"] = "tdqappapercore_other";
$edit["detail"][$i]["field_name"] = array(
    "defects",
    "parameter",
    "aktual_sample_1",
...
$edit["field"][$i]["input_class"]                 = "required";
$edit["field"][$i]["input_element"]             = "browse";
$edit["field"][$i]["browse_setting"]             = "master_barang_papercore";
$i++;
...
if ($edit["mode"] != "add") {
    ...
    CONCAT(d.nama, '|', d.nomor) AS 'browse|nomormhbarang'
