...
//------------------------------------------------GRID DATA 1------------------------------------------------------
$i = 0;
$edit["detail"][$i]["table_name"] = "tdbelipenerimaanppic";
$edit["detail"][$i]["field_name"] = array(
    "nomormhbarang",
    "nomormhsatuanqty",
    "nomormhlokasi",
    "nomortdbelipermintaanppic",
    "jumlah_unit",
    "keterangan"
);
...
$edit["field"][$i]["input"]                     = "nomorthbelipermintaanppic";
$edit["field"][$i]["input_class"]                 = "required";
$edit["field"][$i]["input_element"]             = "browse";
$edit["field"][$i]["browse_setting"]             = "permintaan_barang_ppic";
...
$edit["field"][$i]["grid_set"]["colmodel"][$j]["name"] = "'nomortdbelipermintaanppic'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["index"] = "'nomortdbelipermintaanppic'";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["template"] = "coltemplate_general";
$edit["field"][$i]["grid_set"]["colmodel"][$j]["editable"] = "false";
...
if ($edit["mode"] != "add") {
    ...
    , CONCAT(c.kode, '|', c.nomor) AS 'browse|nomorthbelipermintaanppic'
    FROM thbelipenerimaanppic a
    left join mhgudang b on b.nomor = a.nomormhgudang
    left join thbelipermintaanteknik c on c.nomor = a.nomorthbelipermintaanppic
...
<script type="text/javascript">
    ...
    function load_grid_detail() {
		...
		var pages = 'pages/grid_load.php?id=penerimaan_barang_ppic_detail-load&no=' + no + '';
